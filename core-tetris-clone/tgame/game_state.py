...
from telements import ScoreBoard, TetrisCollisionDetector, init_tetromino_at, PIECES
...
class GameState(SubState):
    ...
    def new_game(self):
        ...
        self.collision_detector = TetrisCollisionDetector()
